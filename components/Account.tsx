/**
 * @file Account.tsx
 * @description A new component to display user account and portfolio information.
 */
"use client"
            ...
            <Card className="overflow-hidden">
                <div className="bg-gray-900 text-white p-6">
                    <div className="flex items-center gap-4">
                        <div className="h-16 w-16 rounded-full bg-blue-500 flex items-center justify-center text-2xl font-bold border-2 border-white">

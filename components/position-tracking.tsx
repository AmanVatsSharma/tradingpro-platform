// // File: components/position-tracking.tsx
// // this component provides a user interface for tracking and managing stock positions, including setting stop losses and targets, and closing positions.
// "use client"
...
// export function PositionTracking({ positions, onPositionUpdate }: PositionTrackingProps) {
...
//     return (((currentPrice - position.averagePrice) / position.averagePrice) * 100).toFixed(2)
//   }
...
//       return { status: "Stop Loss Hit", color: "bg-red-100 text-red-800 border-red-200" }
//     }

//     if (position.target && currentPrice >= position.target) {
//       return { status: "Target Hit", color: "bg-green-100 text-green-800 border-green-200" }
//     }

//     return { status: "Active", color: "bg-blue-100 text-blue-800 border-blue-200" }
//   }
...
//                     </Badge>
//                     <Badge variant="outline" className={`text-xs px-2 py-0.5 ${positionStatus.color}`}>
...
//                       <div
//                         className={`font-mono font-semibold text-sm ${position.unrealizedPnL >= 0 ? "text-green-600" : "text-red-600"}`}
//                       >
...
//                     <div className="flex justify-between">
//                       <span>Current:</span>
//                       <span className="font-mono">₹{(position.currentPrice || position.averagePrice).toFixed(2)}</span>
//                     </div>
//                     <div className="flex justify-between">
//                       <span>Day P&L:</span>
//                       <span className={`font-mono ${position.dayPnL >= 0 ? "text-green-600" : "text-red-600"}`}>
...
//                   <span>Current: ₹{(selectedPosition.currentPrice || selectedPosition.averagePrice).toFixed(2)}</span>
//                 </div>
//               </div>
...
//                   Recommended: {selectedPosition.quantity > 0 ? "Below" : "Above"} current price
//                 </p>
//               </div>
...
//                 />
//                 <p className="text-xs text-gray-500">
//                   Recommended: {selectedPosition.quantity > 0 ? "Above" : "Below"} current price
//                 </p>
//               </div>

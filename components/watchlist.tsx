...
// export function Watchlist({ items, watchlistId, quotes, onSelectStock }: WatchlistProps) {
...
//     try {
//       await addStockToWatchlist(session.user.id, stockId, watchlistId)
...
//     try {
//       await removeStockFromWatchlist(session.user.id, itemId)
...
//                 <div className="flex items-center justify-between">
//                   <div className="flex-1" onClick={() => onSelectStock(item)}>
//                     <h3 className="font-semibold text-sm">{item.symbol}</h3>
//                     <p className="text-xs text-gray-500 truncate max-w-[150px]">{item.name}</p>
//                   </div>
//                   <div className="flex items-center gap-4">
//                     <div className="text-right" onClick={() => onSelectStock(item)}>
...
//                   onClick={() => handleRemoveStock(item.watchlistItemId)}

...
//     mutation CreateWatchlist($userId: String!, $name: String!) {
...
//   mutation AddWatchlistItem($watchlistId: String!, $stockId: String!) {
//     insertIntowatchlistItemCollection(
//       objects: [{ watchlistId: $watchlistId, stockId: $stockId }]
//     ) {
//       records {
//         id
//       }
...
//   mutation RemoveWatchlistItem($id: String!) {
...
// // -----------------------------
// // Main Unified GraphQL Query
// // -----------------------------

// const GET_DASHBOARD_DATA = gql`
//   query GetDashboardData($userId: String!) {
//     # Fetch Trading Account (Portfolio)
//     tradingAccountCollection(filter: { userId: { eq: $userId } }) {
//       edges {
//         node {
//           id
//           balance
...
//     watchlistCollection(filter: { userId: { eq: $userId } }) {
//       edges {
//         node {
//           id
//           name
...
//     # Fetch Positions (Requires Trading Account ID, fetched separately for now)
//     # Note: A more advanced GraphQL schema could nest this under the tradingAccount
//     positionsCollection(
//       filter: { tradingAccount: { userId: { eq: $userId } } }
//       orderBy: [{ createdAt: DescNullsLast }]
//     ) {
//       edges {
//         node {
